...
class ServiceDeatil extends StatefulWidget {
  @override
  _ServiceDeatilState createState() => new _ServiceDeatilState();
 }
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        ...
        title: Text("Detalle del Servicio", style: TextStyle(color: Colors.white),),
      ),
      body: Center(
        child: ListView(
            ...
            /*Card(
              child: Column(
                children: <Widget>[
                  ...
                  ListTile(
                    title: Text('20/02/2018', style: TextStyle(fontWeight: FontWeight.w500)),
                    leading: Icon(Icons.date_range),
                  ) ,
                  ListTile(
                    title: Text('8:30 AM', style: TextStyle(fontWeight: FontWeight.w500)),
